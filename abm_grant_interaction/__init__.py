...
_variation_path = _os.path.join(_resources_directory, _variation_file)
assert _os.path.exists(_variation_path)

_variety_populator = _VarietyPopulator(_variation_path)
